...
const MEMES = [
  ...
  {id:"q3", title:"السؤال ٣", media:"assets/videos/q3.mp4", type:"video",
   ...
   choices:["بق بق بقيييق؟","انا احس الملكة اقوى؟","اهي مو الامبراطورة اقوى من الملكة؟"], answer:2},
  ...
  {id:"q5", title:"السؤال ٥", media:"assets/images/q5.png", type:"image",
   ...
   choices:["مرييم وين ريلج ، يعني شبي فيه؟","انا ملاك الكويتيه ما عندي شخصية","اقوى شييي انا اقوى شي"], answer:0},
  ...
  {id:"q7", title:"السؤال ٧", media:"assets/videos/q7.mp4", type:"video",
   ...
   choices:["يا لحجييييه يااا احسس","يا فعليًا يا احسسس","يا حرفيًا يا فعليًا يا احسسس"], answer:2},
  ...
  {id:"q11", title:"السؤال ١١", media:"assets/images/q11.png", type:"image",
   ...
   choices:["كيف يصبح الانسان مليونير؟","هل نحن وحدنا؟","انت من فين؟ من الجنوب او جده؟"], answer:0},
